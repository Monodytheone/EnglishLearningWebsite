...
{
    public partial class CreateT_ME_EncodingItems : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileSizeInByte = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    OutputUrl = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    DestFormat = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false),
